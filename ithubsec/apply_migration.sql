-- Миграция: AddDocumentIdToMessage
-- Добавление столбца DocumentId в таблицу Messages
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        AND constraint_name = 'FK_Messages_Documents_DocumentId'
    ) THEN
        ...
        ELSE
            RAISE WARNING 'Таблица Documents не существует! Сначала примените миграцию AddDocumentsTable';
        END IF;
    ELSE
